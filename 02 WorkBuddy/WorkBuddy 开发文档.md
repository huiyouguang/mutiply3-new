...
├─────────────────────────────────────────────┤
│           Obsidian Vault (文件系统)          │
│   TaskNotes/  00 Inbox/  04成长/  03Life os/ │
└─────────────────────────────────────────────┘
```
...
```typescript
// 示例：健康数据路径
PATHS.health("2025-07-27") → "TaskNotes/健康数据/2025-07-27.md"
```
...
| 健康追踪 | `01 主页/健康追踪.md` | 读取 `TaskNotes/健康数据/*.md` |
| 心情日记 | `01 主页/主页2.md` Block2 | 读取 `TaskNotes/心情/*.md` |
