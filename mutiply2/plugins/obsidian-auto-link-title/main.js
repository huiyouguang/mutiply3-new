...
class AutoLinkTitleSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            .setName("增强默认粘贴")
            .setDesc("使用默认粘贴命令在编辑器中粘贴链接时，获取链接标题")
            .addToggle((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("将所选文字保留为标题")
            .setDesc("粘贴时是否优先使用选中的文本而非获取的标题作为标题")
            .addToggle((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("网站黑名单")
            .setDesc("禁止自动完成网站标题的字符串列表（逗号分隔）。可以是 URL 或任意文本.")
            .addTextArea((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("使用新爬虫")
            .setDesc("使用实验性新版抓取器，在桌面端效果良好但移动端可能不佳。")
            .addToggle((val) => val
        ...
        new obsidian.Setting(containerEl)
            .setName("链接预览 API 密钥")
            .setDesc("LinkPreview.net 服务的 API 密钥。请访问 https://my.linkpreview.net/access_keys 获取")
            .addText((text) => text
            .setValue(this.plugin.settings.linkPreviewApiKey || "")
            .onChange((value) => __awaiter(this, void 0, void 0, function* () {
            const trimmedValue = value.trim();
            if (trimmedValue.length > 0 && trimmedValue.length !== 32) {
                new obsidian.Notice("链接预览API密钥必须为32个字符");
...
class AutoLinkTitle extends obsidian.Plugin {
    ...
    onload() {
        return __awaiter(this, void 0, void 0, function* () {
            console.log("正在加载 Obsidian 自动链接标题");
    ...
    convertUrlToTitledLink(editor, url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (start < 0) {
                console.log(`在当前编辑器中未找到文本“${pasteId}”，操作中止；链接 ${url}`);
            }
            else {
    ...
    fetchUrlTitleViaLinkPreview(url) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.settings.linkPreviewApiKey.length !== 32) {
                console.error("链接预览API密钥长度不足32个字符，请检查设置");
                return "";
            }
            try {
    ...
    onunload() {
        console.log("卸载 Obsidian 自动链接标题插件");
    }
    loadSettings() {
        return __awaiter(this, void 0, void 0, function* () {
