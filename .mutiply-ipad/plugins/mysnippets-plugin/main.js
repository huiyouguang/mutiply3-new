    ...
    if (!menuExists) {
        ...
        currentSnippets.forEach((snippet) => {
            ...
            menu.addItem((snippetElement) => {
                ...
                function changeSnippetStatus(value) {
                    customCss.setCssEnabledStatus(snippet, value);
                }
                const toggleContainer = toggleComponent.toggleEl;
    ...
    onload() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.addCommand({
                ...
                name: `在状态栏中打开片段`,
                icon: `pantone-line`,
                callback: () => snippetsMenu(this.app, this, this.settings),
            });
            this.addCommand({
