...
var BaseLLMService = class {
  ...
  processTagsFromResponse(content) {
    try {
      ...
      const uniqueTags = [...new Set(tags.map((tag) => this.sanitizeTag(tag.toString())))].filter((tag) => tag.length > 0);
      ...
      if (typeof contentOrAnalysis === "string") {
        ...
        switch (this.settings.taggingMode) {
          ...
          case "hybrid" /* Hybrid */:
            ...
            break;
          case "custom" /* Custom */:
            const customPredefinedTags = this.settings.tagSourceType === "file" ? await TagUtils.getTagsFromFile(this.app, this.settings.predefinedTagsPath) || [] : TagUtils.getAllTags(this.app);
            analysis = await this.llmService.analyzeTags(
              content,
